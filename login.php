...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $query = $conn->prepare("SELECT Username, Email, Passcode FROM Users WHERE Email = ?");
...
<body>
  ...
  <header>
    ...
    <nav id="navbar">
      ...
      <a href="index.html" class="nav-branding" target="_blank"><img src="./media/logo.webp"
  ...
  <main id="login_container">
    ...
    <!-- Section leading to sign in page -->
    <aside class="side_container login">
      <h1>Hello , Welcome to Ivana's World!</h1>
      <p>Don't have an account?</p>
      <a href="signin.html"><button>Sing In</button></a>
    </aside>
  </main>
  ...
  <footer>
    ...
    <section class="madeby">
      ® Group K (Elvira Negreeva, Ibrahim Cab Onder, Ibrahim Gurses), Griffith
      College, 2025
    </section>
  </footer>
  <!-- Script -->
